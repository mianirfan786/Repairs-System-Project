...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($username==""){
		...
		header('location:'.$_SERVER['PHP_SELF'].'?msg=um');
		exit;	
	}elseif($rfc==""){
		header('location:'.$_SERVER['PHP_SELF'].'?msg=up');
		exit;	
...
$msg="Thanks message";
	...
	$html="<table><tr><td>Username</td><td>$username</td></tr><tr><td>useremail</td><td>$useremail</td></tr><tr><td>userphone</td><td>$userphone</td></tr><tr><td>Club</td><td>$Club</td></tr></table>";
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="mirfan2648@gmail.com";
	$mail->Password="@Punjabians58585656";
	$mail->SetFrom("mirfan2648@gmail.com");
...
<head>
	...
	<title>ENNOIA REQUEST FOR MEMBERSHIP CANCELLATION</title>
...
<body>
	...
	<div class="container my-4">
   	...
   	<div class="container">
		...
		<h1><a href="https://www.idamru.com/">ENNOIA REQUEST FOR MEMBERSHIP CANCELLATION</a></h1>
				...
				<div class="col-sm-6">
					...
					<form method="post">
						...
						<!---	<div class="form-group">
							...
							<label>Club <span class="text-danger">*</span></label>
							<input type="text" name="Club" id="Club" class="form-control" placeholder="Club" required>--->
							<div class="form-group">
							<label>Club</label>
							<select class="form-control" name="Club" required>
                            <option value="">Select your club</option>
                            <option value="Ebene">Ebene</option>
                            <option value="Gblc">Gblc</option>
						...
						<div class="form-group">
							...
							<input type="text" name="userphone" id="userphone"  placeholder="Enter user phone" required>
							...
							<input type="text" name="rfc" id="rfc" class="form-control" placeholder="Reason for cancellation" required>
